void setup() {
    ...
    // Criar o tabuleiro e jogadores e  zerar as variáveis.
    //
    // 0: Posição vazia
    ...
    // Iniciar o jogo, definir quem jogara primeiro
    int jogadorDaVez = 1;

    // Registrar a jogada do primeiro jogador
    velha = 1;
    do {
        Serial.print(tabuleiro[0]); Serial.print(tabuleiro[1]);
        Serial.println(tabuleiro[2]); Serial.print(tabuleiro[3]);
        Serial.print(tabuleiro[4]); Serial.println(tabuleiro[5]);
        Serial.print(tabuleiro[6]); Serial.print(tabuleiro[7]);
        ...
        if (validaPosicao(jogada)) {
            ...
            // Converter a jogada do texto em dois inteiros linha e coluna.
...
coluna = jogada.substring(2, 3).toInt();
            ...
            if (tabuleiro[3 * linha + coluna] == 0) {
                ...
                // Informar ao Jogador 1 que a posição está preenchida
            }
        } else {
